...
host can read back entries that describe the hotness of a particular region of
...
An example command line is::
  ...
  range_size=1024,randomized_downsampling=0,hotness_granual=12/ -- sleep 10
